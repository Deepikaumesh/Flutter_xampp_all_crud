...
class Firebase_image2_Mainpage extends StatefulWidget {
  const Firebase_image2_Mainpage({Key? key}) : super(key: key);

  @override
  _Firebase_image2_MainpageState createState() =>
      _Firebase_image2_MainpageState();
}

class _Firebase_image2_MainpageState extends State<Firebase_image2_Mainpage> {
